...
function firstMCard() {
  ...
  document.querySelector("#poster1").src = localFilm[0].poster;
...
function secondMCard() {
  ...
  document.querySelector("#poster2").src = localFilm[1].poster;
...
function thirdMCard() {
  ...
  document.querySelector("#poster3").src = localFilm[2].poster;
...
function forthMCard() {
  ...
  document.querySelector("#poster4").src = localFilm[3].poster;
...
function generateInstructionList(location, cardList, glass) {
  ...
  for (let i = 0; i < location.instructions.length; i++) {
    const list1 = document.querySelector(cardList);
    var iList = document.createElement("li");
    iList.innerText =
      location.instructions[i] + "-(" + location.measures[i] + ")";
    list1.append(iList);
  }
}
function firstCard() {
